...
class Solution(object):
	def assign_cookies(self, children, cookies):
		...
		pChild = 0
		pCookie = 0
		while pCookie < len(cookies) and pChild < len(children):
			if cookies[pCookie] >= children[pChild]:
				pChild += 1
				pCookie += 1
				ans += 1
			else:
...
child2 = [1, 2]
cookie2 = [1, 2, 3]
print(obj.assign_cookies(child1, cookie1), obj.assign_cookies(child2, cookie2))
